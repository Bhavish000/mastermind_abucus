...
const Teacher_inquiry_form = ({onClose}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (Captcha) {
            try {
                const response = await axios.get(`https://tt.mastermindschool.co.in/api/post_teacher_inquiry_data?name=${formData.Name}&email_id=${formData.email}&mobile_no=${formData.phoneNumber}&city=${formData.city}&country_id=${formData.countryid}&state_id=${formData.stateId}`);
    ...
    return (
        <>
            ...
            <i onClick={onClose} class="fa-solid fa-xmark"></i>
                ...
                {/* <Images src={logo} alt="Mastermind Logo" style={{height:30}}/> */}
                <div className="text-xl py-2 font-bold"> ABACUS TEACHER&apos;S INQUIRY </div>
                </div>
                <form
                    ...
                    <input className="w-full py-1  mb-2 " placeholder="Enter Your City" name="city" type="text" required />
                    <ReCAPTCHA
...
export default Teacher_inquiry_form
...
//             <div className="rounded-2xl border-[0.4px] md:px-6 p-4 md:py-5 border-orange-500 shadow-2xl bg-white">
//                 <div className='flex justify-between'>
//                 <img src={logo} alt="Mastermind Logo" className='logoImg' />
//                 <div className="text-xl py-2 font-bold"> ABACUS TEACHER’S INQUIRY </div>
//                 </div>
//                 <form
//                     onSubmit={handleSubmit}
...
//                     </div>
//                     <input className="w-full py-1 " placeholder="Enter Your City" name="city" type="text" required />
//                     <ReCAPTCHA
//                         sitekey="6LdEAyAbAAAAAJW_ibc-uIp7JsrlEwXUd_cs1scy"
//                         onChange={onChange}
//                     />
//                     {Captchaerror ? <span className='danger' >Please Select Captcha</span> : null}
//                     <span className="text-sm text-gray-500 pt-1">By registering here, I agree to Mastermind Abacus <a className='text-blue-600' href='https://www.mastermindabacus.com/terms?_gl=1*y57x04*_up*MQ..'>Terms & Conditions</a> and <a className='text-blue-600 ' href='https://www.mastermindabacus.com/privacy-policy?_gl=1*16oj2r1*_up*MQ..'>Privacy Policy</a></span>
//                     <button className="btns btn-anim bg-orange-600 hover:bg-red hover:text-black border-[1px] hover:border-orange-600 rounded-lg text-sm px-4 py-3 mt-6 text-center font-semibold text-white ease-in-out duration-300 w-full hover:shadow-lg hover:shadow-orange-600/40">
//                         SUBMIT
//                     </button>
