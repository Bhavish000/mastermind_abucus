...
// import footerLogo1 from '../../../assets/img/mastermindabacus-logo.png';
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            <div className="footer-logo mb-30">
                                <Link href="/" as="/">
                                    <Image src={footerLogo ? footerLogo : footerLogo1} alt="Logo" />
                                </Link>
                            </div>
                        ...
                        <div className="col-lg-3 col-md-12 col-sm-12 pl-50 md-pl-14 footer-widget md-mb-50">
                            ...
                            <ul className="site-map">
                                ...
                                <li><Link href="/login">Login</Link>/<Link to="/register">Register</Link></li>
                            </ul>
                        </div>
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget">
                            ...
                            <div className="recent-post mb-20">
                                <div className="post-img">
                                    <Image src={postImg1} alt="blog image" />
                                </div>
                            ...
                            <div className="recent-post mb-20">
                                <div className="post-img">
                                    <Image src={postImg2} alt="blog image" />
                                </div>
                                <div className="post-item">
                                    <div className="post-desc">
